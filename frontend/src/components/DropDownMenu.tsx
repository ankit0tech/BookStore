...
const DropDownMenu = <T extends string> ({title, defaultValue, selectedOptionStatus, setSelectedOptionStatus, options, getLabel}: DropDownMenuProps<T>) => {
    ...
    return (
        <div 
            className="w-full relative border rounded-md text-gray-800"
        >
            <button
            ...
            <div 
                className={`min-w-full text-gray-800 p-2 absolute left-0 top-full mt-1 shadow-md flex flex-col items-start bg-white border border-gray-300 rounded-md z-10 outline-hidden transition-[opacity,scale,tansform] duration-200 
