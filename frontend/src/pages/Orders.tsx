                                    ...
                                    <div className="space-y-1">
                                        <div className="flex flex-row justify-between">
                                            ...
                                            <p className="ml-2 flex flex-row items-center justify-between text-sm">
                                                ...
                                                <span className="text-blue-700 font-medium text-xs mx-2 py-1 px-2 bg-blue-50 rounded-lg">{prettifyString(item.order_status.toLowerCase())}</span>
                                            </p>
                                        </div>
                                        <div className="flex flex-row justify-between">
                                            ...
                                            <p className="flex flex-row items-center justify-between text-sm">
                                                ...
                                                <span className="text-green-700 font-medium text-xs mx-2 py-1 px-2 bg-green-50 rounded-lg">{prettifyString(item.payment_status.toLowerCase())}</span>
                                            </p>
                                        </div>
                                    </div>
