        ...
        <div className="p-4 flex flex-col gap-4">
            <div className="flex justify-between items-center my-4">
                ...
                <button
                    ...
                    ><AiOutlinePlus className="inline"/> Create new category
                </button>
            </div>
            <div className="flex gap-2">
                <input 
                    className="w-full border appearance-none focus:outline-none focus:shadow-sm rounded-lg py-2 px-3" 
                    type="text" 
                    placeholder='Search categories...'
                />
                <button
                    className="py-2 px-3 text-sm text-gray-800 border rounded-lg whitespace-nowrap hover:bg-gray-100 transition-colors duration-200"
                    type='button'
                >
                    Sort A-Z
                </button>
